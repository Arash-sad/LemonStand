...
//  LemonStand
//
//  Created by Arash Sadeghieh E on 22/09/2014.
...
class ViewController: UIViewController {
    ...
    @IBAction func unpurchaseLemonButtonPressed(sender: AnyObject) {
        ...
        if lemonsToPurchase > 0 {
            ...
            showAlertWithText(message:"You don't have any lemon left")
        }
        updateMainView()
    }
    ...
    @IBAction func unpurchaseIceCubeButtonPressed(sender: AnyObject) {
        ...
        if iceCubesToPurchase > 0 {
            ...
            showAlertWithText(message:"You don't have any ice cube left")
        }
        updateMainView()
    }
    ...
    func findAverage(data:[Int]) -> Int {
        ...
        var rounded:Int = Int(ceil(average)) //round up !
        return rounded
    }
